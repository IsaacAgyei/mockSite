...
function FileUploader() {
  ...
  // Uploading clientFile to Cloud Storage
  const handleFileUpload = async (e) => {
    ...
    try {
      if (selectedFile !== '') {
        ...
        // Adding the 'clientfile' field and the selected file as value to our FormData object
        ...
        await axios({
          method: 'post',
          url:  '/user/api/upload', //will need to set proxy should be "/api/upload" '
          data: fileData,
